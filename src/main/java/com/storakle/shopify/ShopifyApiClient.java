...
public interface ShopifyApiClient {
  ...
  @RequestLine(
      "GET /admin/customers.json?limit={limit}&since_id={since-id}&page={page}&fields={fields}")
  ...
  @RequestLine(
      "GET /admin/custom_collections.json?limit={limit}&since_id={since-id}&page={page}&fields={fields}")
  ...
  @RequestLine(
      "GET /admin/smart_collections.json?limit={limit}&since_id={since-id}&page={page}&fields={fields}")
  ...
  @RequestLine(
      "GET /admin/products.json?limit={limit}&since_id={since-id}&page={page}&fields={fields}")
  ...
  @RequestLine(
      "GET /admin/webhooks.json?limit={limit}&since_id={since-id}&page={page}&fields={fields}")
